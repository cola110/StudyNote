                    ...
                    case "short":
                        {
                            ...
                            if (val > 0) outStr.AppendLine(_Indent + "if (" + field1.ColumnName + " == 0)"
                                                           + field1.ColumnName + " = " + dVal + ";");
                        }
                        break;
                    case "DateTime":
                        {
                            ...
                            if (datetime.Year >= 1900)
                                outStr.AppendLine(_Indent + "if (" + field1.ColumnName + ".Year<1900)" + field1.ColumnName
